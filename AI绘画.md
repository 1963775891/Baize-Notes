...
#### **4.1.1  sd upscale 低重绘放大**

sd upscale可以比较容易在低重绘幅度，大概是0.25~0.35之间，且较低CFG时，可以比较轻松得到一张比较
不错的高清图片，你只需要建立一个CFG重绘幅度的矩阵，就可以看的很清楚。

#### **4.1.2 Tiled diffusion 放大**
...
#### **4.1.3 Tiled diffusion和controlnet的tile模型叠加使用**
